...
exports.credorParamsSchema = exports.updateCredorSchema = exports.createCredorSchema = void 0;
...
exports.createCredorSchema = zod_1.z
    .object({
...
exports.updateCredorSchema = zod_1.z
    .object({
...
exports.credorParamsSchema = zod_1.z.object({
    id: zod_1.z.string().uuid('ID inválido'),
});
//# sourceMappingURL=credor.validation.js.map